...
st.markdown(
    "<h1 style='text-align: center'>📚 ProsePredict: Advanced LSTM & GRU Text Forecasting</h1>",
...
st.markdown(
    "<h3 style='text-align: left'>📝 Type Your Text:</h3>", unsafe_allow_html=True
)
...
st.markdown(
    "<h4 style='text-align: center'> 🚀 Customize Your Own ProsePredict Model!</h4>",
    unsafe_allow_html=True,
)
st.markdown(
...
st.markdown(
    "<h4 style='text-align: center'>© 2024 Bhuvan Kapoor 👨</h4>",
    unsafe_allow_html=True,
)
